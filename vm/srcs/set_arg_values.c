...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2018/03/13 10:53:52 by vbaudron          #+#    #+#             */
/*   Updated: 2018/03/15 13:05:11 by bfruchar         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int		set_arg_3_value(t_arg *arg, t_arena *arena, t_proc *process)
{
	...
	arg->value = (unsigned char *)malloc(sizeof(unsigned char)
			* process->exe_op->ocp_op->size_arg3);
	if (arg->value == NULL)
...
int		set_arg_2_value(t_arg *arg, t_arena *arena, t_proc *process)
{
	...
	arg->value = (unsigned char *)malloc(sizeof(unsigned char)
			* process->exe_op->ocp_op->size_arg2);
	if (arg->value == NULL)
		return (perror_int("Error ", 0));
